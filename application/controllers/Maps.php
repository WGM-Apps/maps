...
class Maps extends CI_Controller {
	...
	function get_data_tip()
    {
        ...
        foreach ($list as $field) {
			...
			// <a class='text-dark' href='javascript:void(0)' onclick ='delete_maps($field->id)'><i class='fa fa-trash'></i></a>
			// <a class='text-dark' href='javascript:void(0)' data-toggle='modal' data-target='#deleteModal'><i class='fa fa-trash'></i></a>
